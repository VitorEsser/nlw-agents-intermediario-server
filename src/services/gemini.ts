...
export async function generateAnswer(
  ...
  const prompt = `
    ...
    - Se visualizar alguma palavra incompleta seguida por "..." tente verificar qual era a palavra pelo contexto e então transforme a palavra com ... em uma palavra única e sucinta;
  `.trim()
